...
export default function Hero() {
  return (
    <section className="relative w-full h-[420px] overflow-hidden mb-8 rounded-2xl shadow-md">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-beige/90 to-transparent flex flex-col items-center justify-end pb-10 px-4">
        <Logo />
        <h1 className="text-4xl md:text-5xl font-serif text-olive mb-3 drop-shadow bg-beige/70 px-5 py-2 rounded-md backdrop-blur-sm">
          Receitas do que há
        </h1>

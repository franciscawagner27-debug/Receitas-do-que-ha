...
>
  ...
  className="h-24 w-24 sm:h-28 sm:w-28 md:h-32 md:w-32 object-contain notranslate translate-x-10"
/>
  </button>
  ...
  {/* CATEGORIAS */}
<nav className="flex-1 overflow-x-auto lg:overflow-visible no-scrollbar ml-28">
